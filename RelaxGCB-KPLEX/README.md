...
The algorithm is implemented on top of KPLEX (Wang et al. A Fast Maximum k-Plex Algorithm Parameterized by the Degeneracy Gap. IJCAI 2023) with our RelaxGCB.
...
$ make
```
It generates an executable "RelaxGCB-KPLEX".

## Run the code

```sh
$ ./RelaxGCB-KPLEX {path_to_binary_compressed_graph} {k_value}
```

An example of computing the exact maximum 2-plex for the graph brock200-3 is as follows
```sh
$ ./RelaxGCB-KPLEX ../dataset/Binary/brock200-3.bin 2
```
...
```sh
$ g++ ./toBin.cpp -o toBin
$ cp -r ../dataset/Text/brock200-3.col ./
